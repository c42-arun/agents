...
if TYPE_CHECKING:
    from ....models.ls_proposal_notes_summary import LsProposalNotesSummary

class WithAgreementNumberItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /proposals/proposalNotesSummary/{agreementNumber}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/proposals/proposalNotesSummary/{agreementNumber}{?getPayoutNotes*,tenantSchema*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[WithAgreementNumberItemRequestBuilderGetQueryParameters]] = None) -> Optional[LsProposalNotesSummary]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[LsProposalNotesSummary]
        """
        ...
        return await self.request_adapter.send_async(request_info, LsProposalNotesSummary, None)
    ...
    class WithAgreementNumberItemRequestBuilderGetQueryParameters():
        def get_query_parameter(self,original_name: str) -> str:
            ...
            if original_name == "get_payout_notes":
                return "getPayoutNotes"
            if original_name == "tenant_schema":
                return "tenantSchema"
            return original_name
        
        get_payout_notes: Optional[bool] = None
