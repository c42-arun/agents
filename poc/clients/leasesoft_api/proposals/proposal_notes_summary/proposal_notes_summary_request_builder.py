...
class ProposalNotesSummaryRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /proposals/proposalNotesSummary
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new ProposalNotesSummaryRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/proposals/proposalNotesSummary", path_parameters)
    
    def by_agreement_number(self,agreement_number: str) -> WithAgreementNumberItemRequestBuilder:
        """
        Gets an item from the clients.leasesoft_api.proposals.proposalNotesSummary.item collection
