...
class WithAgreementNumberItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/document/email/attachment/agreement/{agreementNumber}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/document/email/attachment/agreement/{agreementNumber}{?attachmentId*,datahubId*,dipRecord*,schema*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[WithAgreementNumberItemRequestBuilderGetQueryParameters]] = None) -> Optional[bytes]:
        """
    ...
    class WithAgreementNumberItemRequestBuilderGetQueryParameters():
        def get_query_parameter(self,original_name: str) -> str:
            ...
            if original_name == "attachment_id":
                return "attachmentId"
