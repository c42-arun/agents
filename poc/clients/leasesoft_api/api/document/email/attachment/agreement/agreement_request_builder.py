...
class AgreementRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/document/email/attachment/agreement
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/document/email/attachment/agreement", path_parameters)
    
    def by_agreement_number(self,agreement_number: str) -> WithAgreementNumberItemRequestBuilder:
        """
        Gets an item from the clients.leasesoft_api.api.document.email.attachment.agreement.item collection
