...
if TYPE_CHECKING:
    from .......models.ls_agreement_summary import LsAgreementSummary

class SummaryRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/datahub/{goldenRecordId}/agreements/{agreementNo}/summary
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/datahub/{goldenRecordId}/agreements/{agreementNo}/summary{?noCache*,tenantSchema*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[SummaryRequestBuilderGetQueryParameters]] = None) -> Optional[LsAgreementSummary]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[LsAgreementSummary]
        """
        ...
        return await self.request_adapter.send_async(request_info, LsAgreementSummary, None)
