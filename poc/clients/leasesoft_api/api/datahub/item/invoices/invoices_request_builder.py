...
if TYPE_CHECKING:
    from .....models.ls_invoice import LsInvoice

class InvoicesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/datahub/{goldenRecordId}/invoices
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/datahub/{goldenRecordId}/invoices{?agreementNo*,tenantSchema*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[InvoicesRequestBuilderGetQueryParameters]] = None) -> Optional[list[LsInvoice]]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[list[LsInvoice]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, LsInvoice, None)
