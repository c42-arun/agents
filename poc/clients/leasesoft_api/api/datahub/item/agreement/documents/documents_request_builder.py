...
class DocumentsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/datahub/{goldenRecordId}/agreement/documents
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/datahub/{goldenRecordId}/agreement/documents{?agreementNo*,noCache*,tenantSchema*}", path_parameters)
