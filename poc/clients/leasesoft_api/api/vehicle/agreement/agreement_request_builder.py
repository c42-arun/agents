...
class AgreementRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/vehicle/agreement
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/vehicle/agreement{?noCache*,regNumber*,tenantSchema*}", path_parameters)
