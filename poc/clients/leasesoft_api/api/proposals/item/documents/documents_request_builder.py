...
if TYPE_CHECKING:
    from .....models.ls_document import LsDocument

class DocumentsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/Proposals/{proposalNo-id}/documents
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/Proposals/{proposalNo%2Did}/documents{?brokerShortName*,noCache*,tenantSchema*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[DocumentsRequestBuilderGetQueryParameters]] = None) -> Optional[list[LsDocument]]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[list[LsDocument]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, LsDocument, None)
