...
if TYPE_CHECKING:
    from ....models.ls_financial_profile import LsFinancialProfile

class ProfilesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/financial/profiles
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/financial/profiles{?agreementNo*,tenantSchema*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[ProfilesRequestBuilderGetQueryParameters]] = None) -> Optional[list[LsFinancialProfile]]:
        """
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[list[LsFinancialProfile]]
        """
        ...
        return await self.request_adapter.send_collection_async(request_info, LsFinancialProfile, None)
